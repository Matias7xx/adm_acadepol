...
class Dormitorio extends Model
{
    ...
    {
        return $this->vagas_ocupadas < $this->capacidade_maxima && $this->status === 'ativo';
    }
    ...
    public function getClasseStatusAttribute()
    {
        ...
        if ($percentual == 0) return 'bg-green-100 text-green-800';
        if ($percentual <= 50) return 'bg-yellow-100 text-yellow-800';
        if ($percentual < 100) return 'bg-orange-100 text-orange-800';
