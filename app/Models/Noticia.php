...
class Noticia extends Model
{
    ...
    public function getSanitizedConteudoAttribute()
    {
        ...
        return \Mews\Purifier\Facades\Purifier::clean($this->conteudo, [
            'HTML.Allowed' => 'p,b,i,u,strong,em,h2,h3,h4,ul,ol,li,a[href|target],br,blockquote,img[src|alt|width|height|class],iframe[src|width|height|frameborder|allowfullscreen],table,tr,td,th',
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($noticia) {
            ...
            if ($noticia->conteudo) {
                ...
                preg_match_all('/<img[^>]+src="([^"]*\/storage\/noticias\/[^"]+)"[^>]*>/i', $noticia->conteudo, $matches);
                ...
                $pastaNoticia = 'noticias/' . UploadHelper::sanitizeFolderName($noticia->titulo);
