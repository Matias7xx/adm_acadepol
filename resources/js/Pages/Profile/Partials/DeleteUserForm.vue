...
const deleteUser = () => {
    form.delete(route('profile.destroy'), {
        ...
        onError: () => {
            ...
            toast.error('Não foi possível excluir sua conta. Verifique sua senha e tente novamente.');
        },
        onFinish: () => form.reset(),
    });
};
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal" max-width="md">
            <div class="p-6">
                ...
                <p class="mt-3 text-sm text-gray-600">
                    Esta ação é irreversível. Uma vez que sua conta for excluída, todos os seus recursos e dados serão 
                    permanentemente apagados e você não terá mais acesso ao sistema.
                </p>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-red-700">
                                <ul class="list-disc pl-5 space-y-1">
                                    ...
                                    <li>Você perderá acesso a todas as suas matrículas e cursos</li>
                                    <li>Seu histórico e certificados não poderão ser recuperados</li>
                ...
                <div class="mt-6">
                    ...
                    <p class="text-sm text-gray-600 mb-2">Digite "excluir conta" para confirmar que deseja prosseguir:</p>
                    <TextInput
                        id="confirmation"
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <DangerButton
                        :class="{ 'opacity-25': form.processing || isButtonDisabled }"
