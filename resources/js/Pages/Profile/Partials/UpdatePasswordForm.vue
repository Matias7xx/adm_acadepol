        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">
                    A senha deve conter pelo menos 8 caracteres e incluir letras maiúsculas, minúsculas, números e símbolos.
                </p>
            </div>
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton :disabled="form.processing" class="px-4 py-2 bg-[#bea55a] hover:bg-[#a89048]">
