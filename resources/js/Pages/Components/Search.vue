  ...
  <div class="flex flex-col items-center space-y-2 w-full max-w-lg mx-auto">
    <div class="relative w-full">
      <input
        ...
        class="pl-10 pr-10 py-2 border rounded-lg focus:ring-1 focus:ring-[#bea55a] focus:border-[#bea55a] w-full transition-all bg-white text-gray-800 border-gray-300 shadow-sm"
      />
      <div
