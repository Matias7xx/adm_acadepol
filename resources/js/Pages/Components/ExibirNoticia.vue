...
<template>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <nav class="mb-6 text-sm text-gray-600" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center">
          <li class="flex items-center">
            ...
            <svg class="h-4 w-4 mx-2 text-gray-400" viewBox="0 0 16 16" fill="currentColor">
      ...
      <article class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="p-6 pb-0">
          ...
          <div class="flex flex-wrap items-center text-gray-600 gap-x-4 gap-y-2 mb-4">
            <!-- Data de publicação -->
        ...
        <!-- Imagem principal -->
        <div v-if="noticia.imagem && imagemCarregada" class="relative aspect-video overflow-hidden">
          <img 
            :src="noticia.imagem" 
            :alt="noticia.titulo" 
        ...
        <div class="p-6">
          ...
          <div class="flex flex-wrap justify-between items-center border-t border-gray-200 pt-6 mt-8">
            <button 
              @click="voltarParaLista" 
              class="flex items-center text-gray-600 hover:text-[#a38e4d] transition-colors"
            >
            ...
            <div class="flex items-center space-x-2">
              <span class="text-sm text-gray-500 mr-2">Compartilhar:</span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow">
          ...
          >
            ...
            <span class="font-medium text-[#bea55a] hover:text-[#a38e4d] transition-colors line-clamp-2">
  ...
  <div 
    v-if="linkCopiado" 
    class="fixed bottom-4 right-4 bg-gray-800 text-white px-4 py-2 rounded-lg shadow-lg flex items-center z-50 animate-fade-in"
  >
