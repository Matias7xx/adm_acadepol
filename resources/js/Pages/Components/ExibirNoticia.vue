...
const dataAtualizacaoFormatada = computed(() => {
  ...
  try {
    ...
    if (diff < 86400000) { // 24h em milissegundos
...
const compartilhar = (plataforma) => {
  window.open(urlsCompartilhamento.value[plataforma], '_blank', 'width=600,height=400');
};
...
<template>
  ...
  <main class="bg-gray-50 py-4 sm:py-8">
    <div class="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6">
      <!-- Breadcrumbs -->
      <nav class="mb-4 sm:mb-6 text-xs sm:text-sm text-gray-600" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center">
          <li class="flex items-center">
            <Link href="/" class="hover:text-blue-600 hover:underline">Home</Link>
            <svg class="h-3 w-3 sm:h-4 sm:w-4 mx-1 sm:mx-2 text-gray-400" viewBox="0 0 16 16" fill="currentColor">
      ...
      <article class="bg-white rounded-lg sm:rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="p-4 sm:p-6 pb-4 sm:pb-0">
          ...
          <div class="flex flex-wrap items-center text-gray-600 gap-x-2 sm:gap-x-4 gap-y-2 mb-3 sm:mb-4 text-xs sm:text-sm">
            <!-- Data de publicação -->
        ...
        <div class="p-4 sm:p-6">
          ...
          <div class="mb-6 sm:mb-8 text-base sm:text-lg text-gray-700 font-medium border-l-4 border-[#bea55a] pl-3 sm:pl-4 py-2 bg-yellow-50 rounded-r-md">
            {{ noticia.descricao_curta }}
          </div>
          
          <!-- Conteúdo principal -->
          <div class="prose prose-sm sm:prose-base lg:prose-lg max-w-none mb-8 sm:mb-12" v-html="noticia.conteudo"></div>
          
          <!-- Barra de compartilhamento -->
          <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center border-t border-gray-200 pt-4 sm:pt-6 mt-6 sm:mt-8 gap-4">
            <button 
            ...
            <div class="flex items-center justify-center sm:justify-end space-x-2">
              <span class="text-sm text-gray-500 mr-2 hidden sm:inline">Compartilhar:</span>
              <span class="text-xs text-gray-500 mr-2 sm:hidden">Compartilhar:</span>
              ...
              <div class="flex space-x-1 sm:space-x-2">
                ...
                >
                  <svg fill="currentColor" viewBox="0 0 24 24" class="h-4 w-4 sm:h-5 sm:w-5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mt-6 sm:mt-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 sm:p-4 hover:shadow-md transition-shadow">
          ...
          >
            <span class="text-xs sm:text-sm text-gray-500 mb-1 flex items-center">
            ...
            <span class="font-medium text-[#bea55a] hover:text-[#a38e4d] transition-colors line-clamp-2 text-sm sm:text-base">
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 sm:p-4 hover:shadow-md transition-shadow">
          ...
          <div v-else class="flex flex-col h-full items-end text-right opacity-50">
            <span class="text-xs sm:text-sm text-gray-500 mb-1 flex items-center">
              Próxima Notícia
              <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 sm:h-4 sm:w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
  ...
  >
    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-green-400" viewBox="0 0 20 20" fill="currentColor">
      <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
    </svg>
    <span class="hidden sm:inline">Link copiado para a área de transferência!</span>
