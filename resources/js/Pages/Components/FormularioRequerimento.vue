...
const submeterRequerimento = () => {
  ...
  for (const campo of ['nome', 'cargo', 'matricula', 'cpf', 'email', 'telefone', 'tipo_requerimento', 'descricao']) {
  ...
  form.post(route('requerimentos.store'), {
    ...
    onError: (errors) => {
      ...
      if (errors.message) {
        ...
        toast.error('Ocorreu um erro ao enviar o requerimento. Por favor, tente novamente.');
      }
    }
  });
};
  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
    ...
    <div class="bg-gradient-to-r from-black to-gray-900 text-white py-5 shadow-md">
      <div class="container mx-auto flex justify-between items-center px-4">
        ...
        <Link :href="route('home')" class="flex items-center text-blue-400 hover:text-blue-300 transition">
          <span>Voltar</span>
    ...
    <div class="container mx-auto py-8 px-4">
      <div class="bg-white rounded-lg shadow-lg p-6 mb-6 border border-gray-200">
        ...
        <!-- Aviso Importante -->
        <div class="bg-gradient-to-r from-blue-50 to-blue-50 border-l-4 border-blue-500 p-4 mb-6 shadow-sm">
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <p class="mt-1 text-sm text-blue-700">
                Preencha todos os campos corretamente. Sua solicitação será analisada pela equipe da ACADEPOL e você será notificado por e-mail sobre o status do requerimento.
              </p>
            </div>
          </div>
        </div>
        ...
        <form @submit.prevent="submeterRequerimento" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input 
                  ...
                  type="text" 
                  class="w-full bg-slate-100 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                  required
                  readonly
                >
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  class="w-full border-gray-300 rounded-md shadow-sm bg-slate-100 focus:border-blue-500 focus:ring focus:ring-blue-200"
                  readonly
                  required
                >
              ...
              <div>
                ...
                <input 
                  ...
                  type="text" 
                  class="w-full border-gray-300 bg-slate-100 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                  required
                  readonly
                >
              </div>
              ...
              <!-- Órgão/Instituição -->
              <div>
                <label for="orgao" class="block text-sm font-medium text-gray-700 mb-1">
                  Órgão/Instituição *
                </label>
                <input 
                  id="orgao" 
          ...
          <div class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div class="space-y-4">
              ...
              <div>
                <label for="tipo_requerimento" class="block text-sm font-medium text-gray-700 mb-1">
                  Tipo de Requerimento *
                </label>
                <select 
                ...
                >
                  ...
                  <option v-for="tipo in tiposRequerimento" :key="tipo.id" :value="tipo.id">
                    {{ tipo.nome }}
                  </option>
                </select>
              </div>
              ...
              <!-- Documento Anexo -->
              <div>
                <label for="documento_anexo" class="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div class="mb-6">
            ...
            >
              <h4 class="font-bold mb-2">TERMO DE RESPONSABILIDADE E ACORDO PARA ENVIO DE REQUERIMENTOS</h4>
              
              <p class="mb-3">Ao submeter este requerimento, o usuário declara estar ciente e concordar com as seguintes condições:</p>
              
              <ol class="list-decimal ml-5 space-y-2 mb-4">
                <li>As informações fornecidas neste requerimento são verdadeiras e de minha inteira responsabilidade;</li>
                <li>Estou ciente de que o fornecimento de informações falsas pode configurar crime de falsidade ideológica, conforme previsto no Art. 299 do Código Penal;</li>
                <li>A ACADEPOL analisará o requerimento de acordo com as normas e procedimentos internos vigentes;</li>
                <li>Os prazos para análise e resposta podem variar de acordo com a complexidade do requerimento;</li>
                <li>Serei notificado sobre o andamento e resultado do requerimento através do e-mail informado neste formulário;</li>
                <li>Documentos anexados devem estar legíveis e em formatos aceitos pelo sistema;</li>
                <li>A ACADEPOL se reserva o direito de solicitar documentos adicionais caso necessário para a análise do requerimento;</li>
                <li>Todos os dados pessoais fornecidos serão tratados de acordo com a Lei Geral de Proteção de Dados Pessoais (LGPD);</li>
                <li>Estou ciente de que o requerimento pode ser deferido ou indeferido, conforme análise técnica e administrativa;</li>
                <li>Em caso de dúvidas sobre o andamento do requerimento, deverei entrar em contato através dos canais oficiais da ACADEPOL.</li>
              </ol>
            ...
            <div class="flex items-start mb-4">
              ...
              <label for="aceita_termos" class="ml-2 text-sm font-medium text-gray-700">
                Declaro que li e aceito os termos e condições para envio de requerimentos
              </label>
            </div>
          </div>
          ...
          <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 mt-8 pt-6 border-t border-gray-200">
            <button 
              type="submit" 
              class="bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-8 rounded-md font-medium transition-all duration-300 shadow hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300 flex items-center justify-center"
