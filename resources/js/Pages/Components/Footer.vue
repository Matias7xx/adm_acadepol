...
<template>
  <footer class="bg-black text-gray-300" role="contentinfo">
    <div class="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-10">
      <!-- Grid Principal -->
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8 items-start"
      >
        <!-- Coluna 1: Institucional -->
        <div
          class="flex flex-col items-center sm:items-start text-center sm:text-left space-y-3 lg:col-span-1"
        >
          <h2 class="text-lg font-bold text-white tracking-wide">ACADEPOL</h2>
          <p class="text-sm leading-relaxed text-gray-300 max-w-xs">
            Academia de Polícia Civil da Paraíba. Formação e capacitação para
            segurança pública.
          </p>
        </div>
        ...
        >
          ...
          <ul class="space-y-2">
            <li>
              <a
                href="/cursos"
                class="text-sm hover:text-[#a38e4d] transition-colors duration-200"
              >
                Cursos
              </a>
            </li>
      ...
      <div class="mt-6 md:mt-8 pt-4 border-t border-gray-800">
        ...
        >
          <p class="text-xs text-gray-400 text-center sm:text-left">
            &copy; {{ new Date().getFullYear() }} ACADEPOL. Todos os direitos
            reservados.
          </p>
          <p class="text-xs text-gray-400 text-center sm:text-right">
            <span class="text-[#a38e4d] font-medium"
