      ...
      <div class="bg-white rounded-lg shadow-lg p-6 mb-6 border border-gray-200">
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <p class="mt-1 text-sm text-amber-700">
                Preencha corretamente todos os campos para que possamos responder sua solicitação adequadamente. Nossa equipe responderá sua mensagem o mais breve possível.
              </p>
            </div>
          </div>
        </div>
        ...
        <form @submit.prevent="submeterContato" class="space-y-8">
          ...
          <div class="mb-6">
            ...
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500">
                Por favor, seja o mais específico possível para que possamos melhor atender sua solicitação.
              </p>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-4 rounded-lg mb-6 text-sm border">
            ...
            <p class="mb-3">
              Ao enviar este formulário, você concorda com nossa política de privacidade. Seus dados serão utilizados exclusivamente para responder à sua solicitação e não serão compartilhados com terceiros.
            </p>
          </div>
