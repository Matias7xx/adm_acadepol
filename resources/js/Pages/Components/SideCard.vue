...
<template>
  <div class="space-y-4">
    <h3 class="text-lg font-bold text-gray-700 mb-4 pl-2 border-l-4 border-[#bea55a]">
      Serviços
    </h3>
    ...
    <div class="bg-white hover:bg-gray-50 shadow rounded-lg transition-all duration-300 
      ...
      <div class="p-4 flex items-center gap-4">
        ...
        <div class="flex-1">
          ...
          <a href="/alojamento/escolha-tipo" class="text-sm font-medium text-[#bea55a] hover:text-yellow-600 inline-block mt-2 group-hover:underline">
            Reservar agora →
          </a>
        </div>
      </div>
