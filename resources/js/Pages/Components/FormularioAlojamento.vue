        ...
        <form @submit.prevent="submeterReserva" class="space-y-8">
          ...
          <div class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <!-- Número -->
              <div>
                <label for="endereco_numero" class="block text-sm font-medium text-gray-700 mb-1">
                  Número
                </label>
                <input 
                  id="endereco_numero" 
          ...
          <div class="mb-6">
            ...
            >
              ...
              <p class="mb-3">Ao solicitar a pré-reserva de alojamento, o usuário declara estar ciente e concordar com as seguintes condições:</p>
            ...
            <div class="flex items-start mb-4">
              ...
              <label for="aceitaTermos" class="ml-2 text-sm font-medium text-gray-700">
                Declaro que li e aceito os termos e condições para utilização do alojamento
              </label>
            </div>
          </div>
