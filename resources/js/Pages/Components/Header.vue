...
<template>
  <div class="bg-[black] py-5 md:py-7 lg:py-10 shadow-md">
    <div
      class="max-w-screen-xl mx-auto px-4 md:px-8 lg:px-14 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6"
    >
      <!-- Logos -->
      <div
      ...
      <!-- Links -->
      <div
        class="grid grid-cols-1 sm:flex items-center justify-center md:justify-end gap-3 sm:gap-4 md:gap-6 w-full md:w-auto"
      >
        <Search />
        <!-- <a 
