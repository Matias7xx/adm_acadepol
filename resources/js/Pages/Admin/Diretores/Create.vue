    ...
    <SectionMain>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
          <CardBox class="mb-6">
            <div class="space-y-6">
              <div>
                ...
                >
                  <FormControl
                    ...
                    autofocus
                  />
                  <div v-if="form.errors.nome" class="text-red-400 text-sm mt-1">
                    {{ form.errors.nome }}
                  </div>
                </FormField>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    />
                    <div v-if="form.errors.data_inicio" class="text-red-400 text-sm mt-1">
                  ...
                  >
                    ...
                    />
                    <div v-if="form.errors.data_fim" class="text-red-400 text-sm mt-1">
                ...
                <FormField label="Status">
                  <div class="flex items-center space-x-3 p-3 rounded-lg">
                    ...
                    />
                    <label class="text-sm font-medium text-gray-700 cursor-pointer" @click="form.atual = !form.atual">
                      É o diretor atual
                    </label>
                    <div v-if="form.atual" class="flex items-center text-green-600 text-sm">
                  ...
                  <div v-if="form.errors.atual" class="text-red-400 text-sm mt-1">
                    {{ form.errors.atual }}
                  </div>
                </FormField>
              </div>
              ...
              <!-- Histórico -->
              <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Histórico Profissional</h3>
                ...
                >
                  <FormControl
                    ...
                    rows="4"
                  />
                  <div v-if="form.errors.historico" class="text-red-400 text-sm mt-1">
              ...
              <!-- Realizações -->
              <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Principais Realizações</h3>
                ...
                <div class="space-y-3">
                  ...
                  <div v-if="form.realizacoes.length > 0" class="space-y-2">
                    ...
                    >
                      ...
                      <span class="flex-1 text-sm text-gray-700">{{ realizacao }}</span>
                      <button 
                        type="button" 
                  ...
                  <div v-else class="text-center py-8 text-gray-500">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Digite no campo acima para adicionar</p>
                  </div>
                  
                  <div v-if="form.errors.realizacoes" class="text-red-400 text-sm">
        ...
        <div class="lg:col-span-1">
          <CardBox>
            <div class="space-y-4">
              <h3 class="text-lg font-semibold text-gray-900">Imagem do Diretor</h3>
              ...
              >
                ...
                <p class="text-sm text-gray-600 mb-1">Clique ou arraste uma imagem</p>
