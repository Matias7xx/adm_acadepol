...
<template>
  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
    ...
    <!-- Cabeçalho -->
    <div class="bg-black text-white py-5 shadow-md" style="background: linear-gradient(to right, #000000, #111827)">
      <div class="container mx-auto flex justify-between items-center px-4 gap-4">
        ...
        <Link :href="route('cursos')" class="flex items-center text-amber-400 hover:text-amber-300 transition flex-shrink-0">
