...
<template>
  <div class="bg-gray-100 min-h-screen">
    <Head>
      ...
      <meta name="keywords" content="manual do aluno, acadepol, academia de polícia, normas, orientações, formação policial" />
    </Head>
      ...
      <div class="lg:col-span-2" id="documento">
        ...
        <div class="mt-8 bg-white shadow-md rounded-lg p-6">
          ...
          <p class="text-gray-600">
            Este documento é uma ferramenta fundamental para o sucesso na formação policial, pois estabelece 
            as bases para uma experiência de aprendizado disciplinada e produtiva. Todos os alunos devem 
